...
# ============================================================================
# Domain-change scoring.
#
# The rest of this block moved to protein_impact/scoring.py with the impact
# flow. hmm_change_impact stays because generate_gene_pdf.py labels its HMM
# track with it; protein_impact/scoring.py carries an identical copy, and the
# two must be changed together (protein_impact/tests asserts they agree).
# ============================================================================
