...
def main():
    ...
    # Regenerate only the parametrized cases in INPUT_FILES (run_one clears each
    # case dir itself). Do NOT wipe OUTPUT_ROOT wholesale — the leafcutter/rMATS/
    # MAJIQ subset references and the slow leafcutter_full reference live here too
    # and are (re)generated by their own tests, not this script.
